...
The distribution is normally distributed. There is a slight skew in the left direction, but the shape still creates a bell. The range of data covered by one standard deviation from the mean is about 8 to 16. This represents one standard deviation above and below the mean
